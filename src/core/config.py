...
# ]
# ============================================================
# ANCHORS clustered with K-means
# ============================================================
ANCHORS = [
    [(0.5643, 0.3238), (0.5034, 0.4359), (0.4458, 0.6062)],   # scale 13×13 (large objects)
    [(0.303, 0.3115), (0.5222, 0.2435), (0.4154, 0.3667)],  # scale 26×26 (medium objects)
    [(0.1468, 0.101), (0.2371, 0.1811), (0.3955, 0.2188)],   # scale 52×52 (small objects)
]
