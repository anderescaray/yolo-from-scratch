...
# ============================================================
ANCHORS = [
    [(0.45, 0.4657), (0.4966, 0.5514), (0.4191, 0.7544)],   # scale 13×13 (large objects)
    [(0.6558, 0.219), (0.2669, 0.7079), (0.5374, 0.3774)],  # scale 26×26 (medium objects)
    [(0.4106, 0.2461), (0.2562, 0.4073), (0.378, 0.3635)],   # scale 52×52 (small objects)
]
